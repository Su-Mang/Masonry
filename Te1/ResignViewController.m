...
@interface ResignViewController ()<UITextFieldDelegate,PassDelegate>
...
- (void)viewDidLoad {
    ...
    [loginbutton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self.view).mas_offset(50*padding); make.size.mas_equalTo(CGSizeMake(70, 40));
    }];
...
-(void)zhuce {
    [self.delegate put:_zztextField.text :_mmtextField.text ];
